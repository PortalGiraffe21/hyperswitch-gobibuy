...
pub use self::{
    ...
    iatapay::Iatapay, imerchantsolutions::Imerchantsolutions, inespay::Inespay, itaubank::Itaubank,
    ...
    mpgs::Mpgs, multisafepay::Multisafepay, nestpay::Nestpay, netcetera::Netcetera, nexinets::Nexinets,
